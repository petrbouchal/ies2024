...
Fiscal federalism != actual political federalism: large variation in role of local spending even in unitary states 
...
![](images/prague-property-income.png)
...
![:scale 80%](images/property.tax.sng.income.pc.ppp.usd.png)
...
The political problem of spending too much vs. the administrative problem of not being able to implement spending plans properly
...
Election cycles visible in overall spending

---

# Implementation gap ...chart needs redoing...

![](images/praha-implgap.png)
...
TO DO: advert for R packages etc.
